...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Task Management System | User Sign-Up </title>
                       ...
                       <div class="col-md-8 col-sm-7">
                           <div class="single-blog-body">
                                ...
                                <div class="Leave-your-thought mt50">
                                    <h3 class="aside-title uppercase">User Sign-Up</h3>
                                    <div class="row">
...
<span style="font-size:11px; color:red">Password atleast one number and one uppercase and lowercase letter, and at least 6 or more characters</span>
 ...
 <div class="input-box post-comment" style="color:blue; col-md-2 col-sm-2 col-xs-2"> 
 	Already Registered?<p></p><a href="signin.php">Sign-In</a>
</div>
</div>
