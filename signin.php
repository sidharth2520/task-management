...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Task Management System | User Sign-In </title>
                       ...
                       <div class="col-md-8 col-sm-7">
                           <div class="single-blog-body">
                                <div class="Leave-your-thought mt50">
                                    <h3 class="aside-title uppercase">User Sign-In</h3>
                                    <div class="row">
...
<input type="submit" value="Sign In" name="signin" class="submit uppercase"> 
</div>
</div>

 <div class="col-xs-12 mt30">
 <div class="input-box post-comment" style="color:blue;"> 
  Not Registered yet? <p> </p> <a href="signup.php" > Sign Up</a>
</div>
</div>
